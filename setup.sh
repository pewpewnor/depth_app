...
show_next_steps() {
    ...
    echo "Next steps:"
    echo ""
    echo "1. For Android development:"
    echo "   flutter run android"
    echo "   ./build.sh apk-release"
    echo ""
    echo "2. For iOS development:"
    echo "   flutter run ios"
    echo "   ./build.sh ios"
    echo ""
    echo "3. For desktop development:"
    echo "   flutter run linux"
    echo "   flutter run macos"
    echo "   flutter run windows"
    echo ""
    echo "4. To build APK:"
    echo "   ./build.sh apk-release"
    echo ""
